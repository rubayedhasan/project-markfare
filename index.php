    ...
    <header class="w-4/5 mx-auto my-10 md:my-14 rounded-md">
        ...
        <nav class="navbar bg-[#054F731A] border border-[#054F731A] rounded-md shadow-sm mt-8 xl:mt-0">
            <div class="navbar-start lg:hidden">
                <div class="dropdown">
                    <div tabindex="0" role="button" class="border border-[#551a8b]/60 bg-[#551a8b]/40 p-2 rounded-md lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 md:h-6 w-4 md:w-6" fill="#551a8b" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16" />
                        </svg>
                    </div>
                    <ul
                        tabindex="-1"
                        class="menu menu-sm dropdown-content bg-base-100 border border-[#551a8b]/60 rounded-box z-1 w-52 p-2 shadow mt-4">
                        <li>
