        ...
        <section class="branding flex flex-col xl:flex-row items-center gap-3">
            ...
            <div class="brand-information flex-1 grid grid-col-1 md:grid-cols-12 gap-6 lg:gap-3 ">
                ...
                <ul class="social-media md:col-span-6 lg:col-span-3 flex justify-evenly lg:justify-center xl:justify-end items-center gap-2.5 xl:pr-5 order-last lg:order-first">
                    <li class="border border-[#054F731A] bg-[#054F731A] hover:ring-1 hover:ring-[#551a8b]/60 hover:drop-shadow-md transition-all duration-300 px-1.5 py-1.5 rounded-full flex items-center cursor-pointer">
            ...
            <div class="navbar-start lg:hidden">
                <div class="dropdown">
                    <div tabindex="0" role="button" class="border border-[#551a8b]/60 p-2 rounded-md lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 md:h-6 w-5 md:w-6" fill="#551a8b" viewBox="0 0 24 24" stroke="#551a8b">
                    ...
                    <ul
                        ...
                        <li>
                            <a class="font-semibold text-sm text-opacity-80 relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-[#551a8b] after:transition-all after:duration-300 hover:text-[#551a8b] hover:bg-transparent hover:after:w-full" href="./services.php">Our Work</a>
                        </li>
                        <li>
                            <a class="font-semibold text-sm text-opacity-80 relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-[#551a8b] after:transition-all after:duration-300 hover:text-[#551a8b] hover:bg-transparent hover:after:w-full" href="./tissue_culture.php">Tissue Culture</a>
                        </li>
                        <li>
                            <a class="font-semibold text-sm text-opacity-80 relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-[#551a8b] after:transition-all after:duration-300 hover:text-[#551a8b] hover:bg-transparent hover:after:w-full" href="./blog.php">Blog</a>
                        </li>
                        <li>
                            <a class="font-semibold text-sm text-opacity-80 relative after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-[#551a8b] after:transition-all after:duration-300 hover:text-[#551a8b] hover:bg-transparent hover:after:w-full" href="./about.php">About</a>
                        </li>
                    </ul>
                </div>
            </div>
